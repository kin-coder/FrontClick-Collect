<!-- <div class="webcarte">
    ...
    <form action="">
            <input type="submit" class="btn boutcommand" value="Commandez" id="btncommandCarte">
    </form>
              
</div>

<div class="mobilecarte">
...
<!-- <div class="horraire-image">
    ...
    <div class="horraire-image w-carte mx-auto position-relative">
        <div class="text-center">
            <img src="../../assets/images/Rectangle16.png" class="w-100">
        </div>
        <div class="position-absolute Rectangle17">
            <div class="row align-items-center">
                <div class="text-center w-100 align-middle">
                    <strong>
                    ENTREES <br>                                                            
                    Œuf dur, mayo &nbsp; &nbsp;5 <br>
                    Tentacule de poulpe à la plancha, houmous et grenade &nbsp; &nbsp;9 <br>
